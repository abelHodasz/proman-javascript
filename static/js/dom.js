        ...
        dataHandler.getColumn(statusId, function (column) {
            let columnHtml = `
                    <div class="board-column" id = "board-${boardId}-status-${statusId}>
                        <div id="colTitle-${boardId}-col-${statusId}" class="handle board-column-title">${column[0].title}
                        <div class="column-delete"><i id="delete-column-board-${boardId}-status-${statusId}" class="fas fa-trash-alt"></i></div>
                        </div>
                        <div id="board-${boardId}-col-${column[0].id}" class="handle board-column-content"></div>
                    </div>`;
            ...
            for (let status of statuses) {
                let column = `
                    <div class="board-column" id = "board-${boardId}-status-${status.id}">
                        ...
                        <div class="column-delete"><i id="delete-column-board-${boardId}-status-${status.id}" class="fas fa-trash-alt"></i></div>
